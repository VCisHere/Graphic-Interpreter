...
HDC hDC;
char SrcFilePath[2018 + 1];
static char *Name = "Graphic Interpreter";
...
int PrepareWindow(HINSTANCE hInst, HINSTANCE PrevInstance, int nCmdShow)
{
    HWND hWnd;
    WNDCLASS W;
