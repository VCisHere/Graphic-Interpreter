...
void CalcCoord(ExprNode_Ptr x_tree,
               ExprNode_Ptr y_tree,
               double *ptr_x_value,
               double *ptr_y_value)
{
...
void DrawLoop(ExprNode_Ptr start_tree, ExprNode_Ptr end_tree, ExprNode_Ptr step_tree, ExprNode_Ptr x_tree, ExprNode_Ptr y_tree)
{
    double x_val, y_val;
